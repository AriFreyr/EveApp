...
export class OrecalcComponent implements OnInit{
    ...
    onSubmit() {
        ...
        let efficiency: number = (this.model.baseyield/100)*(1+(this.model.reprskill*0.03))*(1+(this.model.repreffskill*0.02))*(1+(this.model.oreeffskill*0.02))*(1+(this.model.implantbonus/100))*(1+(this.model.spacebonus/100));
